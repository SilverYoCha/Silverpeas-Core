...
public abstract class AbstractJpaEntityRepository<ENTITY extends Entity<ENTITY,
  ...
  public List<ENTITY> save(final OperationContext context, final List<ENTITY> entities) {
    CacheServiceFactory.getThreadCacheService().put(OperationContext.CACHE_IDENTIFIER, context);
    try {
      ...
      CacheServiceFactory.getThreadCacheService().remove(OperationContext.CACHE_IDENTIFIER);
    }
  }
