...
public abstract class AbstractEntity<ENTITY extends Entity<ENTITY, IDENTIFIER_TYPE>,
  ...
  protected void performBeforePersist() {
    OperationContext context = CacheServiceFactory.getThreadCacheService()
        .get(OperationContext.CACHE_IDENTIFIER, OperationContext.class);
    context.applyToPersistOperation(this);
  ...
  protected void performBeforeUpdate() {
    OperationContext context = CacheServiceFactory.getThreadCacheService()
        .get(OperationContext.CACHE_IDENTIFIER, OperationContext.class);
    context.applyToUpdateOperation(this);
