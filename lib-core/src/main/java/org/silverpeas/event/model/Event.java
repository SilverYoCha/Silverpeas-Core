...
public class Event extends AbstractJpaEntity<Event, UuidIdentifier> {
  ...
  public boolean isPersonal() {
    return StringUtil.isNotDefined(calendar.getInstanceId()) &&
        StringUtil.isNotDefined(calendar.getTargetResourceUniqueId());
  }
