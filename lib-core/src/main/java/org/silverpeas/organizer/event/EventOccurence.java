...
import org.silverpeas.organizer.Occurrence;
 ...
 * Date: 02/12/13
 */
public class EventOccurence implements Occurrence, Comparable<EventOccurence> {
   ...
   * @return
   */
  public static EventOccurence anOccurrenceFromItsId(String occurrenceId) {
   ...
   * @return
   */
  public static EventOccurence anOccurrence(Event event, Period timeSlot) {
    return new EventOccurence(event, timeSlot);
  }
   ...
   * @param timeSlot
   */
  private EventOccurence(Event event, Period timeSlot) {
    this.event = event;
  ...
  @Override
  public int compareTo(final EventOccurence otherEventOccurence) {
    return getOccurrenceId().compareTo(otherEventOccurence.getOccurrenceId());
  }
}
