...
public interface ScheduleEventManager {
   ...
   *         represented by {@link EventOccurence}
   */
  List<EventOccurence> generateOccurrencesInPeriod(final Period period, final Event... events);
   ...
   *         represented by {@link EventOccurence}
   */
  List<EventOccurence> generateOccurrencesInPeriod(final Period period, final List<Event> events);
   ...
   *         represented by {@link EventOccurence}
   */
  List<EventOccurence> generateOccurrencesFrom(final Datable date, final Event... events);
   ...
   *         represented by {@link EventOccurence}
   */
  List<EventOccurence> generateOccurrencesFrom(final Datable date, final List<Event> events);
}
