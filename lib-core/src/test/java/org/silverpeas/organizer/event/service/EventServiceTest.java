...
import org.silverpeas.organizer.event.constant.EventInfoType;
...
import org.silverpeas.organizer.event.model.EventAttendee;
import org.silverpeas.organizer.event.model.EventInfo;
import org.silverpeas.organizer.event.service.mock.OrganizationControllerMock;
...
public class EventServiceTest {
  ...
  public void testGetById_00() {
    ...
    assertThat(event.getCalendar().getUserSetting(), nullValue());
    ...
    assertThat(event.getUserSetting(), nullValue());
  ...
  public void testGetById_01() {
    ...
    assertThat(event.getUserSetting().getRgbColor(), is(Color.BLACK));
    assertThat(event.getPlanning().getEvent(), is(event));
    assertThat(event.getPlanning().getRecurrence(), nullValue());
    assertThat(event.getPlanning().getPeriod(), notNullValue());
    assertThat(
  ...
  public void testGetById_02() {
    ...
    assertThat(event.getCalendar().getUserSetting().getRgbColor(), is(Color.GREEN));
    assertThat(event.getPlanning(), notNullValue());
    ...
    assertThat(event.getUserSetting().getRgbColor(), is(Color.RED));
    assertThat(event.getPlanning().getEvent(), is(event));
    assertThat(event.getPlanning().getRecurrence(), nullValue());
    assertThat(event.getPlanning().getPeriod(), notNullValue());
    assertThat(
